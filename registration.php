                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <button type="submit" class="btn btn-primary" name="register">Register</button> <small class="offset-md-2 offset-sm-2 offset-xs-2">already have registered, click here to  <a class="btn btn-primary" href="login.php" role="button">Login</a> 
                        </form>
                    </div>
                </div>
            </div>
